...
public partial class CobrancaColumnManager : Form
{
    public CobrancaColumns CobrancaModel { get; private set; } = new();

    public CobrancaColumnManager()
    {
        InitializeComponent();
    ...
    private void Import_Click(object sender, EventArgs e)
    {
        ...
        else if (cobrancaColumns.GroupBy(c => c.ColumnIndex).Any(c => c.Count() > 1))
        {
            MessageBox.Show(
