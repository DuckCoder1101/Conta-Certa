...
public partial class CobrancaForm : InputForm
{
    ...
    public CobrancaForm(Cobranca cobranca) : this()
    {
        ...
        foreach (var sc in cobranca.ServicosCobranca)
        {
            ...
            if (scControl != null)
            {
                ...
                scControl.Servico.Valor = sc.Valor;
            }
        }
    }
    ...
    private void CadastrarBtn_Click(object sender, EventArgs e)
    {
        ...
        {
            cobExistente.DocumentoCliente = _cliente.Documento;
            cobExistente.Honorario = honorario;
            cobExistente.Status = status;
            cobExistente.Vencimento = vencimento;
            cobExistente.PagoEm = pagoEm;
